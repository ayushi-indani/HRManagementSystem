...
public class hr_login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            PreparedStatement ps=con.prepareStatement("select * from hr where hr_id=? and password=?");
            ps.setString(1, id);
            ps.setString(2,pwd);
            ...
            if(rs.next())
            {
                ...
                dispose();
                new hr_home(jTextField1.getText()).setVisible(true);
            }
            else
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            Class.forName("com.mysql.jdbc.Driver");
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/hrmanagement","root","root");
            PreparedStatement ps=con.prepareStatement("select * from emp where e_id=? and password=?");
            ps.setString(1,id);
            ps.setString(2,pwd);
            ResultSet rs=ps.executeQuery();      
            int x=0;
...
//                Date d=rs1.getDate(1);
                ...
                String d=s.format(d1);
                new emp_home(jTextField2.getText(),d).setVisible(true);
            }
            else
                JOptionPane.showMessageDialog(this,"Login Failed");
          }catch(Exception e)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(hr_login.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
